<?php
    ...
    $arrProducts = array(
        array(
            'name'          => "Kyrie Irving Brooklyn Nets City",
        ...
        array(
            'name'          => "LeBron James Los Angeles Lakers",
        ...
        array(
            'name'          => "Kevin Durant Brooklyn Nets City",
        ...
        array(
            'name'          => "Devin Booker Phoenix Suns",
        ...
        array(
            'name'          => "Ja Morant Memphis Grizzlies",
        ...
        array(
            'name'          => "Kevin Durant Brooklyn Nets",
        ...
        array(
            'name'          => "Jayson Tatum Boston Celtics",
